...
3. now when we write java classname, the class we are executing mush have the main class and we 
don't have to write the .class. 
4. this is the interpretation phase where JVM is used and it converts it into machine code, the
